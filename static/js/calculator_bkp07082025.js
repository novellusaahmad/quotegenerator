...
class LoanCalculator {
    ...
    initializeEventListeners() {
        ...
        // Input formatting temporarily disabled to fix clearing issue
    ...
    formatInputValue(input) {
        ...
        if (!isNaN(numericValue) && cleanValue !== '') {
            // Don't format if it's 0 or very small numbers to avoid issues
        ...
        // If invalid or empty, leave the field as is - don't clear it
    }
